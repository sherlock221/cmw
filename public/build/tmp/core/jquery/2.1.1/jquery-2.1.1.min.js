...
define("js/cmd/core/jquery/2.1.1/jquery-2.1.1.min", [], function(require, exports, module) {
    !function(a, b) {
        ...
        var t = function(a) {
            ...
            c = fb.support = {}, f = fb.isXML = function(a) {
                ...
                p = !f(e), g && g !== g.top && (g.addEventListener ? g.addEventListener("unload", function() {
                    ...
                    a.querySelectorAll("[selected]").length || q.push("\\[" + M + "*(?:val|" + L + ")"), 
        ...
        n.offset = {
            setOffset: function(a, b, c) {
                ...
                "biz" === k && (a.style.position = "relative"), h = l.offset(), f = n.css(a, "top"), 
