 ...
 */
define("js/cmd/ui/text/jquery.textillate", [ "$" ], function(require, exports, module) {
    var jQuery = require("$");
    (function($) {
    ...
    (function($) {
        ...
        var Textillate = function(element, options) {
            ...
            base.in = function(index, cb) {
                index = index || 0;
                var $elem = base.$texts.find(":nth-child(" + ((index || 0) + 1) + ")"), options = $.extend(true, {}, base.options, $elem.length ? getData($elem[0]) : {}), $chars;
            ...
            base.out = function(cb) {
                var $elem = base.$texts.find(":nth-child(" + ((base.currentIndex || 0) + 1) + ")"), $chars = base.$current.find('[class^="char"]'), options = $.extend(true, {}, base.options, $elem.length ? getData($elem[0]) : {});
