define("js/cmd/util/loader/loader", [], function(require, exports, module) {
    /**
     * 文件预加载器
     * 可加装 js image  css
     * sherlock
    ...
    var LoaderMsk = function(source, color, cb_end) {
        ...
        var doc = document, args = arguments, color = typeof color == "string" ? color : "#E44B46";
        var _loadDom = doc.getElementById("MP_loading"), _txtDom = doc.getElementById("MP_precent");
        if (!_loadDom) {
